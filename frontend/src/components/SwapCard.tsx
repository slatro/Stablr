...
const TokenBox = ({ type, amount, setAmount, token, isReadOnly, balance, onTokenSelect }: any) => {
  ...
  return (
    <div className="flex flex-col h-[506px] w-full max-w-[480px] justify-between group/card">
      ...
      <div className="premium-card p-5 flex-1 flex flex-col justify-center relative mx-0 my-[6px]">
        <TokenBox type="From" token={tokenIn} amount={fromAmount} setAmount={setFromAmount} isReadOnly={false} balance={balanceIn} onTokenSelect={setTokenIn} />
        ...
        <TokenBox type="To" token={tokenOut} amount={toAmount} setAmount={() => {}} isReadOnly={true} balance={balanceOut} onTokenSelect={setTokenOut} />
      </div>
