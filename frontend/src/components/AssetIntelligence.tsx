    ...
    <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-right-4 duration-700">
      ...
      <div className="premium-card p-5 space-y-5">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center text-[10px]">
            ...
            <span className="font-black text-white/60 uppercase">Stablr Decentralized</span>
          </div>
        </div>
      ...
      <div className="p-4 bg-blue-500/5 border border-blue-500/10 rounded-2xl flex gap-3">
         ...
         <p className="text-[9px] text-white/40 leading-relaxed font-medium italic">
           {isAtoken ? "This is an Arc-Collateralized asset. All units are backed 1:1 by institutional-grade liquidity reserves on the Stablr protocol." : "This is a native testnet asset for simulation purposes."}
         </p>
      </div>
    </div>
  );
